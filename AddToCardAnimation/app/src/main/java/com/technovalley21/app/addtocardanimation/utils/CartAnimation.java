...
public class CartAnimation {
    ...
    public CartAnimation() {
    }

    public CartAnimation attachActivity(Activity activity) {
        mContextReference = new WeakReference<Activity>(activity);
        return this;
    }

    public CartAnimation setTargetView(View view) {
        mTarget = view;
        setOriginRect(mTarget.getWidth(), mTarget.getHeight());
        return this;
    }

    private CartAnimation setOriginRect(float x, float y) {
        originX = x;
        originY = y;
        return this;
    }

    private CartAnimation setDestRect(float x, float y) {
        destX = x;
        destY = y;
        return this;
    }

    public CartAnimation setDestView(View view) {
        mDest = view;
        setDestRect(mDest.getWidth(), mDest.getWidth());
        return this;
    }

    public CartAnimation setBorderWidth(int width) {
        mBorderWidth = width;
        return this;
    }

    public CartAnimation setBorderColor(int color) {
        mBorderColor = color;
        return this;
    }

    public CartAnimation setCircleDuration(int duration) {
        mCircleDuration = duration;
        return this;
    }

    public CartAnimation setMoveDuration(int duration) {
    ...
    private AnimatorSet getAvatarRevealAnimator() {
        ...
        final float scaleFactor = 1.5f; // resize your moving object
    ...
    public CartAnimation setAnimationListener(Animator.AnimatorListener listener) {
